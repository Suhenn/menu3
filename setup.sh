...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Suhenn/Asep/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Suhenn/Asep/main/register"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/Suhenn/Asep/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
function menu(){
    ...
    wget https://raw.githubusercontent.com/Suhenn/menu3/main/menu/menu.zip
    7z x -p*NyolongCepetMati menu.zip
    chmod +x menu/*
